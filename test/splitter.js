...
contract('Splitter', (accounts) => {
  ...
  describe("testing split related cases", async () => {
    beforeEach("split", async () => {
      txObject = await splitterInstance.split(accountOne, accountTwo, {from: accountSender, value: amountBN});
    });
